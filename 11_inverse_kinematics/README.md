...
Reminder: the jacobian is given as
$$
    J =
    \left(
    \begin{array}{cc|cccc}
        ...
        \frac{\partial y_n}{\partial x_0} & \frac{\partial y_n}{\partial y_0} & \frac{\partial y_n}{\partial \theta_1} & \frac{\partial y_n}{\partial \theta_2} & \cdots & \frac{\partial y_n}{\partial \theta_n} \\
    \end{array}
    \right)
$$
